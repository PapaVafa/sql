...
-- Select the best day (highest total sales) and worst day (lowest total sales)
...
VALUES (101,'Apple Pie', 'Small', 2,'unit', CURRENT_TIMESTAMP);
...
WITH LastQuantity AS (
  ...
  WHERE vi.rn = 1  most recent
)
UPDATE product_units pu
SET current_quantity = lq.last_quantity
